...
public class AdminEventUnban extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference userRef = firebaseDatabase.getReference().child("Event");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot item : snapshot.getChildren()){
                    ...
                    if (check.compareTo("1")==0){
                        ...
                        addNew.email = String.valueOf(item.child("Phone").getValue());
                ...
                if (lst.size() > 0) {
                    ...
                    AdminUnbanAdapter adapter = new AdminUnbanAdapter(AdminEventUnban.this,lst,title,1);
