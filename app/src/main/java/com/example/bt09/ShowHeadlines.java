...
// find out which intent is calling us & grab data bundle holding selected url & caption sent to us
        ...
        String channelss = myBundle.getString("channelss");
        String items = myBundle.getString("items");
        TextView textView = (TextView) findViewById(R.id.channel_in);
        textView.setText("Items in channel " + items + "_" + channelss);
...
//CAUTION: sometimes TITLE and DESCRIPTION include HTML markers
            ...
            myBuilder.setIcon(R.drawable.meo_with_gun)
