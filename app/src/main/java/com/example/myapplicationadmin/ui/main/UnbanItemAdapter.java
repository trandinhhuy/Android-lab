...
public class UnbanItemAdapter extends ArrayAdapter<String> {
    ...
    public UnbanItemAdapter(Activity context, String[] rp_datetime, String[] rp_reason, String[] rp_detail, int[] id, int type) {
        super(context, R.layout.unban_item, rp_reason);
        this.context=context;
        this.reason=rp_reason;
        this.datetime=rp_datetime;
        this.detail=rp_detail;
        this.id = id;
        this.type = type;
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View v= inflater.inflate(R.layout.unban_item, null,true);

        TextView rpReason = (TextView) v.findViewById(R.id.ub_txt_rpReason);
        TextView rpDatetime = (TextView) v.findViewById(R.id.ub_txt_rpDatetime);
        TextView rpDetail = (TextView) v.findViewById(R.id.ub_txt_rpDetail);

        rpReason.setText(reason[position]);
        rpDatetime.setText(datetime[position]);
        rpDetail.setText(detail[position]);

        TextView btnShowInfo = (TextView)v.findViewById(R.id.ub_btn_showInfo);
        TextView btnUnban = (TextView)v.findViewById(R.id.ub_btn_unban);

        btnUnban.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
                alertDialogBuilder.setMessage("Are you sure? This action can't be undone.");
        ...
        btnShowInfo.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                if (type==1) showEventInfo(position);
