...
public class UnbanEventFragment extends Fragment {
    String[] rpDatetime ={
            "09:50 15/08/2020",
            "12:50 16/08/2020",
            "10:50 17/08/2020",
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        list.setAdapter(new UnbanItemAdapter(getActivity(),rpDatetime,rpReason,rpDetail,rpID,type_user));
